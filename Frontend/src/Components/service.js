...
export default function Service({username}) {
    ...
    const homeLink = username ? `/home?username=${username}` : '/guest';
    ...
    <div>
        ...
        <div className="row">
            <div className="col-md-12 mt-5">
                <h6><Link style={{textDecoration:'none', color:'red'}} to={homeLink}><a style={{ color:'red', textDecoration:'none'}} href="">Home</a></Link>  /   <b>Service</b></h6>
            </div>
        </div>
